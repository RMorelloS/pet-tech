...
public class ProdutoRepository implements IProdutoRepository {
    ...
    static{
        ...
        Produto produto1 = new Produto("Produto 1", "Descrição 1",
                "URL 1", new BigDecimal( 19.99));
        Produto produto2 = new Produto("Produto 2", "Descrição 2",
                "URL 2", new BigDecimal( 23.99));
